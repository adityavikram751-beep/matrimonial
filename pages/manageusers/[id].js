...
export default function UserDetailPage() {
    ...
    if (id) {
      fetch(`${API_URL}/admin/user/${id}`)
        ...
        .catch(err => {
          ...
          setNotFound(true);
          setTimeout(() => router.push('/manageusers'), 3000);
        });
    }
  }, [id]);
  ...
  if (notFound) {
    return (
      <div className="p-8 text-center text-gray-700 text-2xl">
  ...
  if (!user) {
    return (
      <div className="p-8 flex justify-center items-center text-center text-gray-700 text-2xl">
        <Image src="/loading2.gif" height={300} width={300} alt="loading..." />
      </div>
    );
  }
