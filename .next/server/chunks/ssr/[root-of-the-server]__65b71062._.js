...
"[externals]/highcharts/modules/exporting [external] (highcharts/modules/exporting, cjs)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const mod = __turbopack_context__.x("highcharts/modules/exporting", () => require("highcharts/modules/exporting"));
...
if (typeof __TURBOPACK__imported__module__$5b$externals$5d2f$highcharts__$5b$external$5d$__$28$highcharts$2c$__cjs$29$__["default"] === "object") {
    __turbopack_context__.r("[externals]/highcharts/modules/exporting [external] (highcharts/modules/exporting, cjs)")(__TURBOPACK__imported__module__$5b$externals$5d2f$highcharts__$5b$external$5d$__$28$highcharts$2c$__cjs$29$__["default"]);
}
/* -------------------------------
 CONSTANT WEEK STRUCTURE
-------------------------------- */ const WEEK_ORDER = [
    "Sun",
    "Mon",
    "Tue",
...
function DashboardFinal() {
  ...
  -------------------------------- */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        (async ()=>{
            try {
                ...
                const bucket = {};
                json.data.forEach((d)=>{
                    bucket[d.date] = Number(d.newUsers || 0);
                });
                setTrend(WEEK_ORDER.map((day)=>bucket[day] || 0));
            } catch (err) {
                console.log(err);
            }
        })();
  ...
  -------------------------------- */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
    ...
    /* -------------------------------
  FINAL CHART VALUES BASED ON API
  -------------------------------- */ const yellowData = trendData.map((v, i)=>v * SS_YELLOW[i] * 1_000_000);
    const greenData = trendData.map((v, i)=>v * SS_GREEN[i] * 1_000_000);
    /* -------------------------------
       HIGHCHART CONFIG
  -------------------------------- */ const chartOptions = {
        chart: {
        ...
        tooltip: {
            ...
            formatter () {
                return `
          <b>${this.x}</b><br/>
          🟡 New Users: <b>${(this.points[0].y / 1_000_000).toFixed(1)}M</b><br/>
          🟢 Returning: <b>${(this.points[1].y / 1_000_000).toFixed(1)}M</b>
        `;
            }
        },
        plotOptions: {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                            className: "w-full h-[30px] rounded-full bg-gray-200 overflow-hidden shadow-inner",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                                className: "h-full",
                                                style: {
                                                    width: `${pct}%`,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                        className: "w-[120px] text-right text-[20px] font-semibold",
                                        children: item.value
                                    }, void 0, false, {
                                        fileName: "[project]/src/component/analytics/TopSection.js",
                                        lineNumber: 180,
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                className: "flex items-center gap-10 text-gray-700 text-[16px] font-semibold",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65b71062._.js.map