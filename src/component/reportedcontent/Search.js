  ...
  return (
    <div className="border-slate-700 w-full align-item-center ">
      <div className="flex justify-between border-b-2 pb-2 gray-400">
        <h1 className="text-xl text-gray-700 font-semibold">Reported Contents</h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative w-full sm:w-72">
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 bg-white"
            />
